...
const Auth = ({isModel = false}) => {
    ...
    const handleGoogleSignIn = async() => {
        try {
            ...
            const res = await axios.post(`${ServerURL}/api/auth/login`, {name,email},{withCredentials: true,})
        ...
        <div className={`w-full ${isModel ? 'py-4' : 'min-h-screen bg-[#f3f3f3] flex items-center justify-center px-6 py-20'}`} >
            <motion.div
                ...
                <p className='text-gray-500 text-center text-sm md:text-base leading-relaxed mb-8'>
                    Sign in to start AI-powered interview, track your progress, and unlock performace insights
                </p>
                <motion.button
