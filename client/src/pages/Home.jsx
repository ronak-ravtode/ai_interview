...
import { BsBarChart, BsClock, BsFileEarmark, BsFileEarmarkText, BsMic, BsRobot } from 'react-icons/bs';
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block'>
                <span className='bg-green-100 text-green-600 py-1 px-6 rounded-full'>
                  AI Intelligence
                </span>
              </span>
            </motion.h1>
            <motion.p
              ...
              className='text-gray-500 text-lg mt-6 max-w-2xl mx-auto'>
              Role-Based mock interviews with smart follow-ups,adeptive difficulty and real-time performance evaluation.
            </motion.p>
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-black hover:opacity-90 transition shadow-md text-white px-10 py-3 rounded-full' >
                Start Interview
              </motion.button>
              <motion.button
                onClick={() => {
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='border border-gray-300 transition  px-10 py-3 rounded-full' >
                View History
              </motion.button>
            </div>
          </div>
              ...
              [
                {
                  ...
                  desc: "AI adjusts diffuculty based on selected job rule."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
            ...
            <div className='grid md:grid-cols-2 gap-10'>
              {
                [
                  ...
                  },
                  {
                    ...
                    desc: "Project-specific question besed on uploaded resume."
                  },
                  {
                    image: pdfImg,
                  ...
                  },
                  {
                    ...
                    desc: "Trace Progress with performance graph and topic analysis"
                  },
                ].map((item, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
                  ...
                  >
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      ...
                      <div className='w-full md:w-1/2'>
                        <div className='text-green-600 bg-green-50 h-12 w-12 rounded-xl flex items-center justify-center mb-6'>
                          {item.icon}
                        </div>
                ...
                [
                  {
                    ...
                    desc: "Behavioral and communication based evaultion."
                  },
                  {
                    image: techImg,
                  ...
                  },
                  {
                    ...
                    desc: "Based tone and voice analysis insights."
                  },
                  {
                    image: creditImg,
